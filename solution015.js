...
//Parameters
//b, the location of the ball
//arr, an array of arrays giving cup switches
...
//Pseudo Code
//for loop comparing b to each sub element using arr[i][0] type notation
//if b is equal to one of the values then change the value of b
...
// The ball is under cup number : 1
cupAndBalls(1,[[2,3],[1,2],[1,2]]) // returns 1