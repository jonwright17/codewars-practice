...
// Parameters
// array of numbers, the average of all numbers in the array plus x

// Return x (the number that makes the array average to the second parameter)
// or if x is negative return (?)
...
// Pseudo Code
// reduce array 
// rArr + x / arr.length + 1 = newavg
// find x = newavg(arr.length + 1) - rArr
// x < 0 ? -1 : x

function newAvg(arr, newavg) {
    let x = (newavg * (arr.length + 1)) - (arr.reduce((acc, cur) => acc + cur, 0))
    if (x < 0){
